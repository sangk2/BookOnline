...
class Functions
{
	...
	public function sendEmail($email, $temp_password)
	{
		...
		// gmail, pass
		$gmail = "sangtvtpd05314@fpt.edu.vn";
		$pass = "";
		$yourName = "";
		...
		$mail->Body    = 'Hi,<br><br> Your password reset code is <b>' . $temp_password . '</b> . This code expires in 120 seconds. Enter this code within 120 seconds to reset your password.<br><br>Thanks,<br>Admin.';
